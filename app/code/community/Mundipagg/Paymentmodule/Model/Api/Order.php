...
class Mundipagg_Paymentmodule_Model_Api_Order
{
    ...
    public function createBoletoCreditcardPayment(Varien_Object $paymentInformation)
    {
        $boletoCc = Mage::getModel('paymentmodule/api_boletocc');
        $orderRequest = $boletoCc->getCreateOrderRequest($paymentInformation);
        $orderController = $this->getOrderController();
